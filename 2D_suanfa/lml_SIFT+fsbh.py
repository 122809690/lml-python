...
def goodpoints_shaixuan(goodpoints, keypoints1, keypoints2):
    print(goodpoints)
    sum_point_yt = np.mean([[keypoints1[i[0].queryIdx]] for i in goodpoints],
                           axis=1)  # 分别求横纵坐标的均值 [584.58138275 569.50188065]
...
def sift_detect(img1, img2):  # (img1原图  img2模板)
    ...
    goodpoints_shaixuan(good, kp1, kp2)
...
def sift_jioadu(img1, img2):  # (img1原图  img2模板)
    ...
    # 根据特征点连线的方向差求旋转角  做原图旋转预处理 不然仿射变换效果拉胯
    # print(dst_mb[0][0])
    # print(dst_yt[0][1])
